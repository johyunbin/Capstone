...
## 동적 state + 인계 (5/20 18:56 갱신 — Phase 6 §6.4 통계 후속 PoC 3종 실측)

> CLAUDE.md = 라우팅 + 안정 룰. 동적 state·진행 수치는 handoff·v13 정본에 있다 — 새 세션은 아래 anchor 하나로 0% loss 인계.

- **★ 새 세션 진입 anchor (0% loss)**: `@_internal/handoff/active/handoff_20260520_185654_Phase6_PoC통계후속_실측.md` (Phase 6 §6.4 향후 작업의 3종 통계 후속 PoC 실측 — plan-level effect size 분층 · cluster paired bootstrap B=2,000 · variance decomposition Type-III. phase2+phase3 = **20 cell · 580 paired · 4,800 trial 평면**. **핵심 = baseline 제외 model3 condition % SS = 0.00% (p=0.866) → §5.4 B1↔CaseB↔oracle latency 동등 정량 확정**. 보고서 §5.4 표 5-4 + cluster bootstrap 문장 + §5.5 PoC bullet + §6.4 갱신 → compact 15p (정본) + readable 24p PDF 재빌드. PoC 1 plan 회복 그룹 large 5.4% vs 비회복 26.3% (5배). PoC 2 cluster CI 너비 = naïve 의 2.31~2.64×. md2pdf_readable.py output filename fix (compact 덮어쓰기 bug 해결). 정본 수치 carry: 3-7× · 5.67× · 94.9% · 7/12 · 148/156 · 180/180 · 13/168 · 89.1% · 1,508 · 2,880 · 86.9% · plan_signature = Node Type 1-tuple · q9 sel=0.1 honest exception · v2 PPTX ship-ready. 다음 = 5/22 미팅·5/25 팀원 검토·5/26 11:59 PM PPTX Learnus 마감·5/27+5/29 양일 발표·5/28 12:00 포스터·6/5 금 전시회·6/10 박광현 마지막 세미나·6/11 보고서·PoC sf=1·sf=100·SIFT·SSN·다중벡터·4 엔진 확장 deferred)
