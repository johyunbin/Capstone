...
## 동적 state + 인계 (5/20 갱신 — 통계 보강·v3 polish prompt·서버 backup 2.6G 완료 + 16:15 교수님 수업 공지 흡수)

> CLAUDE.md = 라우팅 + 안정 룰. 동적 state·진행 수치는 handoff·v13 정본에 있다 — 새 세션은 아래 anchor 하나로 0% loss 인계.

- **★ 새 세션 진입 anchor (0% loss)**: `@_internal/handoff/active/handoff_20260520_164600_캡스톤강의공지반영_세션종합.md` (Tailscale 동기화 + 5/20 마지막 강의 공지 흡수 + 5 Phase 종합. (1) 일정 정정 — 전시회 6/5 금·세미나 10회 5/25·상호평가 3차 5/26·4차 6/9·박광현 마지막 세미나 6/10·상호평가 결과 6/11 + 발표 5/27+5/29 양일 분산 + 포스터 5/28 12:00 정오 + 무단결석=발표 점수 0점 + 가산점=질문 (2) 보고서 자체 검증·수정 4건 → 신본 `_20260520_162500.{md,pdf,docx}` (Abstract + §8 Acknowledgment 박광현·임채림·박성원 + §2.1·2.2 "기존 시스템 (Background)"·"관련 연구 (Related Work)" 표제 + VBASE/TPC-H/SeqScan acronym 풀이) (3) v2 deck 4 구조 점검 PASS — B20 "한계와 다음 단계" = Future Work, 1 issue: B21 Acknowledgment 이름 부재 → polish 4 후보 (4) 토요일 발행 자료 사전 점검 — 포스터·팜플렛·영상 + 4 단계 checklist (QR·자막·YouTube·이름 추가) (5) figure 5-5 효과크기 분포 신규 (4 panel Phase 2/3 baseline/B1) — 본문 통합 X. **deferred**: Phase 2-B 본문 압축 46p → 14~22p (사용자 목표 20p 이내·10p 내외) + Phase 6 §6.4 통계 후속. 정본 수치 carry: 3-7× · 5.67× · 94.9% · 7/12 · 148/156 · 180/180 · 13/16 · 89.1% · 1,508 · 2,880 · 86.9% · plan_signature = Node Type 1-tuple · q9 sel=0.1 honest exception · v2 PPTX ship-ready carry (raster image, 21장). 다음 = 5/22 미팅·5/25 세미나·5/26 PPTX/상호평가·**5/27+5/29 발표**·5/28 12:00 포스터·**6/5 금 전시회 504호 15:00**·6/10 박광현 세미나·6/11 보고서)
