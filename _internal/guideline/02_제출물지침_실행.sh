#!/bin/bash
# [02] 02_제출물_실행.sh — Phase별 독립 claude 세션으로 제출물 작성
# 사용: cd ~/Capstone && ./guideline/02_제출물지침_실행.sh
set -euo pipefail
cd ~/Capstone

LOG="guideline/제출물.log"
STATE="guideline/PHASE_STATE_02_제출물.md"
...
2. guideline/02_제출물지침_auto.md 의 Phase $P 체크리스트 수행
3. 완료 후 $STATE 업데이트
