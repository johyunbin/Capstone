...
> 상세 스크립트는 `03_문서생성지침_auto.md` 참조.

### Phase 0: 환경 확인 (1분)
- [ ] markdown + websocket-client 설치 확인
- [ ] _internal/scripts/md2pdf.py 존재 확인
- [ ] Chrome 설치 확인
- [ ] guideline/PHASE_STATE_03_문서생성.md 생성
...
- [ ] 누락 파일 순차 변환 (`_internal/scripts/md2pdf.py`)
- [ ] 변환 성공/실패 리포트
- [ ] PHASE_STATE 업데이트
...
| 실수 | 올바른 방법 |
|------|------------|
| fpdf2로 PDF 생성 | Chrome CDP만 사용 (`_internal/scripts/md2pdf.py`) |
