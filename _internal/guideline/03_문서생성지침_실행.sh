#!/bin/bash
# [03] 03_문서생성_실행.sh — Phase별 독립 claude 세션으로 문서생성 실행
# 사용: cd ~/Capstone && ./guideline/03_문서생성지침_실행.sh
set -euo pipefail
cd ~/Capstone

LOG="guideline/문서생성.log"
STATE="guideline/PHASE_STATE_03_문서생성.md"
...
2. guideline/03_문서생성지침_auto.md 의 Phase $P 체크리스트 수행
3. 완료 후 $STATE 업데이트
