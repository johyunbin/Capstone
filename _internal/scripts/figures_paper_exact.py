...
# 일관 style + Korean font (Apple SD Gothic Neo 우선, fallback DejaVu Sans)
plt.rcParams.update({
    "font.family": ["Apple SD Gothic Neo", "AppleGothic", "Malgun Gothic", "DejaVu Sans"],
    "font.size": 11,
    ...
    "axes.unicode_minus": False,  # Korean font 의 - 기호 깨짐 방지
})
