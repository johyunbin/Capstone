#!/usr/bin/env python3
"""8M distance_shell sel 5단계 확장 wrapper (sel 0.01/0.05/0.50)."""
import sys
...
sys.argv = ['distance_shell.py', '--out-prefix', 'rq3_8m_distance_shell_sel_expand']
m.main()
