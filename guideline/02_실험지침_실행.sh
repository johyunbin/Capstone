#!/bin/bash
# [02] 02_실험_실행.sh — Phase별 독립 claude 세션으로 실험 실행
# 사용: cd ~/Capstone && ./guideline/02_실험지침_실행.sh
set -euo pipefail
cd ~/Capstone

LOG="guideline/실험.log"
STATE="guideline/PHASE_STATE_02_실험.md"
...
2. guideline/02_실험지침_auto.md 의 Phase $P 체크리스트 수행
3. 완료 후 $STATE 업데이트
