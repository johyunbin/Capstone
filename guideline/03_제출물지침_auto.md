...
- [ ] 양식 요구사항 정리: 파일 형식(hwp/docx/pdf), 필수 항목, 분량
...
- [ ] research/analysis/ — 관련 시리즈 분석 문서 (기술 배경)
- [ ] research/summaries/ — 핵심 논문 총정리 (선행 연구)
...
echo "분석 시리즈: $(ls research/analysis/*.md 2>/dev/null | wc -l)건"
echo "총정리: $(ls research/summaries/*.md 2>/dev/null | wc -l)건"
