#!/bin/bash
# [05] 05_발표_실행.sh — Phase별 독립 claude 세션으로 발표 준비 실행
# 사용: cd ~/Capstone && ./guideline/05_발표지침_실행.sh
set -euo pipefail
cd ~/Capstone

LOG="guideline/발표.log"
STATE="guideline/PHASE_STATE_05_발표.md"
...
2. guideline/05_발표지침_auto.md 의 Phase $P 체크리스트 수행
3. 완료 후 $STATE 업데이트
