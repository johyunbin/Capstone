#!/bin/bash
# [06] 06_미팅_실행.sh — Phase별 독립 claude 세션으로 미팅 지원 실행
# 사용: cd ~/Capstone && ./guideline/06_미팅지침_실행.sh
set -euo pipefail
cd ~/Capstone

LOG="guideline/미팅.log"
STATE="guideline/PHASE_STATE_06_미팅.md"
...
2. guideline/06_미팅지침_auto.md 의 Phase $P 체크리스트 수행
3. 완료 후 $STATE 업데이트
4. 회의록 저장: records/meetings/YYYYMMDD_제목.md" \
    --allowedTools "$TOOLS" \
