...
- → **25.2× 약화** (magnitude shrinkage) — 단일 정확성은 multi 정확성의 ***필요조건*만 성립** (충분조건 X)
...
**시각**:
- 4강 method × 3 multi cell grouped bar (sel=0.10) + 단일 sweet spot reference -17.13% horizontal line
- multi-vector vs multi-join magnitude 거의 동일 (0.67 ≈ 0.68) 시각 강조
